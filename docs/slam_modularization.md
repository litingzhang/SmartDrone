...
ORB-SLAM3 code is absorbed under `src/native/adapters/slam/orb_slam3` and built as internal modules. Sophus, DBoW2, and
...
ORB-SLAM3 source is split by function under `src/native/adapters/slam/orb_slam3`:
