    ...
    const CameraRuntimeProviderMetadata &cameraProvider)
{
    ...
    std::vector<std::string> notes{
        ...
        "planning.algorithm_plugin=fast_planner_grid_astar",
        "planning.source=fast_planner_native_algorithm_adapter",
        "px4.pose_output_mode=none_position_position_velocity",
