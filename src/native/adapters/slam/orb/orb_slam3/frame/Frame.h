...
public:
  ...
  bool ShouldIgnoreScaleLevelsForProjection() const;
...
public:
  ...
  bool mbStereoFeatureInjected{false};

private:
  void LoadStereoFeatureFrameData(const StereoFeatureFrameData &features);
  void LoadMonoFeatureFrameData(const MonoFeatureFrameData &features);
