...
public:
    ...
    Sophus::SE3f GrabImageStereoWithFeatures(const cv::Mat &imRectLeft, const cv::Mat &imRectRight,
                                             const ExternalStereoFrameData &features, const double &timestamp,
                                             string filename);
    Sophus::SE3f GrabImageMonocularWithFeatures(const cv::Mat &im, const ExternalMonoFrameData &features,
