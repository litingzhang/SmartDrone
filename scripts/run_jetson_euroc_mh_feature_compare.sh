...
SP_LG_INIT_CLOSE_RATIO="${SMART_DRONE_EXTERNAL_STEREO_INIT_MIN_CLOSE_RATIO:-0.48}"
SP_LG_INIT_MIN_FEATURES="${SMART_DRONE_EXTERNAL_STEREO_INIT_MIN_FEATURES:-200}"
SP_LG_FILTERED_STEREO_INJECT="${SMART_DRONE_SP_LG_FILTERED_STEREO_INJECT:-1}"
SP_LG_DEPTH_SCALE="${SMART_DRONE_EXTERNAL_STEREO_DEPTH_SCALE:-0.985}"
SP_LG_WAIT_LOCAL_MAPPING_IDLE="${SMART_DRONE_ORB_WAIT_LOCAL_MAPPING_IDLE:-0}"
SP_LG_WAIT_LOCAL_MAPPING_IDLE_TIMEOUT_MS="${SMART_DRONE_ORB_WAIT_LOCAL_MAPPING_IDLE_TIMEOUT_MS:-200}"
